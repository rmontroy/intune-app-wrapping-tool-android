...
Version [1.0.4549.6](https://github.com/msintuneappsdk/intune-app-wrapping-tool-android/releases/)
...
> This version of the wrapping tool supports targeting Android 15 (API 35) and lower.
...
For instructions on using the Microsoft Intune App Wrapping Tool for Android, please see [Prepare Android apps for mobile application management with the Intune App Wrapping Tool](https://docs.microsoft.com/intune/intune-service/developer/app-wrapper-prepare-android).
